...
const dropdownIds = ['dropdown1', 'dropdown2', 'dropdown3', 'dropdown4', 'dropdown5', 'dropdown6', 'dropdown7', 'dropdown8', 'dropdown9', 'dropdown10', 'dropdown11'];

dropdownIds.forEach(id => {
  document.getElementById(id).addEventListener('change', function () {
    const selectedValue = getDropdownValue(id);
    const currentValue = document.getElementById('prompt').value;
    document.getElementById('prompt').value = currentValue === '' ? selectedValue : currentValue + "," + selectedValue;
  });
});
